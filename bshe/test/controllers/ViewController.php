 ...
 * @license LGPL
 */
class Test_ViewController extends Zend_Controller_Action
{
    /**
     * Ver.9.2 -> 1.0対策
     *
    ...
    public function indexAction()
    {
        try {
            ...
            $params =
                array(
                    'templatePath' => $mainPath . '/www/_bshetemplate/test',
                    'templateFile' => 'viewtest.html', //,
//                    'templateCachePath' => $mainPath . '/cache',
//                    'templateCacheLifeTime' => 60,
//                    'templateCompilePath' => $mainPath . '/template_c',
            ...
            $mainPath = Bshe_Controller_Init::getMainPath();
            $writer = new Bshe_Log_Writer_Dailystream( $mainPath . '/logs', 'BsheView_');
